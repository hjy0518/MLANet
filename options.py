...
parser.add_argument('--load', type=str, default='edgenext_small_usi.pth', help='train from checkpoints')
parser.add_argument('--load1', type=str, default='mobilenetv3-small-55df8e1f.pth', help='train from checkpoints')
